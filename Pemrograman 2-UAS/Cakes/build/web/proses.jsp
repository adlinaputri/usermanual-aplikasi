    ...
    <body>
        <div id="con"><h2>Produk Cupcakes</h2>
            ...
            <%
                ...
                //ResultSet rs;
                int i = st.executeUpdate("insert into produk(id_produk,nama_produk,harga) values ('"+id_produk+"','"+nama_produk+"','"+harga+"')");
                if (i > 0) {
                            Class.forName("com.mysql.jdbc.Driver");
                            ResultSet rs;
            ...
            %>
                ...
                <a href="tampil.jsp"><input type="submit" name="submit" Value="Edit Produk" ></a>
